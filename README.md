...
本仓库同时提供一个严格白名单生成的可构建社区壳，用于展示和改进公开界面；完整产品体验以 GitHub Releases 发布的安装包为准。
...
社区壳保留仪表盘、会话示例、备份示例和纯本地外观设置，使用公开示例数据，不读取或修改本机业务状态。
...
欢迎通过 Issue 提交使用反馈、问题报告和功能建议。为了保护隐私，请勿在 Issue 中上传账号信息、密钥、令牌或包含个人数据的日志与截图。
